...
CREATE TABLE IF NOT EXISTS ai_projects_catalog.agent_demo.ecom_chat_short_term_memory (
...
CREATE TABLE IF NOT EXISTS ai_projects_catalog.agent_demo.ecom_chat_long_term_memory (
